...
public class Project extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        switch (msg) {
            ...
            case "View Information" -> new ViewInformation(meter).setVisible(true);
            case "Update Information" -> new UpdateInformation(meter).setVisible(true);
            case "Bill Details" -> new BillDetails(meter).setVisible(true);
            default -> {
            }
        }
